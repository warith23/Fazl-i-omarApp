...
{
    public partial class ResultChecker : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ContinuousAssessment = table.Column<double>(type: "double", nullable: false),
                    ExamScore = table.Column<double>(type: "double", nullable: false),
